...
def C_String(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_CString = Arg_position_dict().dict_CString
    # feature
    C_String = dict_util.get_C_String(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_CString, C_String)
...
def prev1(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev1 = Arg_position_dict().dict_prev1
    # feature
    prev1 = dict_util.get_prev1(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_prev1, prev1)

def prev1POS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev1POS = Arg_position_dict().dict_prev1POS
    # feature
    prev1POS = dict_util.get_prev1POS(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_prev1POS, prev1POS)

def prev1_C(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev1_C = Arg_position_dict().dict_prev1_C
    # feature
    C_String = dict_util.get_C_String(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_prev1_C, prev1_C)

def prev1POS_CPOS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev1POS_CPOS = Arg_position_dict().dict_prev1POS_CPOS
    # feature
    CPOS = dict_util.get_CPOS(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_prev1POS_CPOS, prev1POS_CPOS)

def prev2(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev2 = Arg_position_dict().dict_prev2
    # feature
    prev2 = dict_util.get_prev2(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_prev2, prev2)

def prev2POS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev2POS = Arg_position_dict().dict_prev2POS
    # feature
    prev2POS = dict_util.get_prev2POS(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_prev2POS, prev2POS)

def prev2_C(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev2_C = Arg_position_dict().dict_prev2_C
    # feature
    C_String = dict_util.get_C_String(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_prev2_C, prev2_C)

def prev2POS_CPOS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_prev2POS_CPOS = Arg_position_dict().dict_prev2POS_CPOS
    # feature
    CPOS = dict_util.get_CPOS(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_prev2POS_CPOS, prev2POS_CPOS)

def conn_to_root_path(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_conn_to_root_path = Arg_position_dict().dict_conn_to_root_path
    # feature
    conn_to_root_path = dict_util.get_conn_to_root_path(parse_dict, DocID, sent_index, conn_indices)
...
def next1(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next1 = Arg_position_dict().dict_next1
    # feature
    next1, next1POS = dict_util.get_next1_next1POS(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_next1, next1)

def next1POS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next1POS = Arg_position_dict().dict_next1POS
    # feature
    next1, next1POS = dict_util.get_next1_next1POS(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_next1POS, next1POS)

def next1_C(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next1_C = Arg_position_dict().dict_next1_C
    # feature
    C_String = dict_util.get_C_String(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_next1_C, next1_C)

def next1POS_CPOS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next1POS_CPOS = Arg_position_dict().dict_next1POS_CPOS
    # feature
    CPOS = dict_util.get_CPOS(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_next1POS_CPOS, next1POS_CPOS)

def next2(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next2 = Arg_position_dict().dict_next2
    # feature
    next2, next2POS = dict_util.get_next2_next2POS(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_next2, next2)

def next2POS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next2POS = Arg_position_dict().dict_next2POS
    # feature
    next2, next2POS = dict_util.get_next2_next2POS(parse_dict, DocID, sent_index, conn_indices)

    return get_feature_by_feat(dict_next2POS, next2POS)

def next2_C(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next2_C = Arg_position_dict().dict_next2_C
    # feature
    C_String = dict_util.get_C_String(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_next2_C, next2_C)

def next2POS_CPOS(parse_dict, DocID, sent_index, conn_indices):
    #load dict
    dict_next2POS_CPOS = Arg_position_dict().dict_next2POS_CPOS
    # feature
    CPOS = dict_util.get_CPOS(parse_dict, DocID, sent_index, conn_indices)
    ...
    return get_feature_by_feat(dict_next2POS_CPOS, next2POS_CPOS)


def all_features_back_up(parse_dict, DocID, sent_index, conn_indices):
    ''' feat dict '''
    feat_dict_CString = {}
    feat_dict_CPOS = {}
    feat_dict_prev1 = {}
