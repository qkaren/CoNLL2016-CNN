...
def build_model(lr, activation, nb_filter, filter_length1, filter_length2, filter_length3,
    ...
    model.add_node(Dropout(0.25),input='embedding1',name='arg_1')
    model.add_node(Dropout(0.25),input='embedding2',name='arg_2')
    # model.add_node(
    ...
    if train:
        ...
        open('cnn_implicit_sense_weight.h5', 'w').write(json_string)
    return model
...
def fit_model(lr, activation, nb_filter, filter_length1, filter_length2, filter_length3,
    ...
    class scorer(Callback):
        ...
        def on_epoch_end(self, epoch, logs={}):
            dev_output = model.predict({'arg1': X_dev_1, 'arg2': X_dev_2,},
