...
def write_result_to_json(predicted_list):
    ...
    dev_feature_file = open(config.IMPLICIT_DEV_FEATURE_OUTPUT_PATH)
    ...
    cmd = "python " + config.SCORER_PATH + \
          " "+config.JSON_GOLD_IMPLICIT_PATH+" "+config.JSON_DEV_OUTPUT_PATH+" "
    os.system(cmd)
...
if __name__ == "__main__":
   cm = get_evaluation(config.IMPLICIT_DEV_OUTPUT_PATH)
   cm.print_out()