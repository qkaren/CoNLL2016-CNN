...
def get_Arg2_Acc(dev_feat_path, dev_result_file_path):
...
if __name__ == "__main__":
   print(get_Arg2_Acc(config.IMPLICIT_ARG2_DEV_FEATURE_OUTPUT_PATH, config.IMPLICIT_ARG2_DEV_OUTPUT_PATH))
