    ...
    class scorer(Callback):
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if acc_dev > scorer.dev_best_acc:
                ...
                print("saving the best model-----the best dev is: ",nb_filter1,nb_filter2,nb_filter3, filter_length1, filter_length2, filter_length3,scorer.dev_best_acc)
                model.save_weights('cnn_non_exp_sense_weights.h5' ,overwrite=True)
            if epoch % 3 == 0:
                print('the best dev is:', nb_filter1,nb_filter2,nb_filter3, filter_length1, filter_length2, filter_length3,'epoch', scorer.dev_epoch_th, 'dev_best_acc:', scorer.dev_best_acc)
            print()
            sys.stdout.flush()
        def on_train_end(self, logs={}):
            print('the final best dev is:',nb_filter1,nb_filter2,nb_filter3, filter_length1, filter_length2, filter_length3, 'dev_epoch', scorer.dev_epoch_th, 'dev_best_acc:', scorer.dev_best_acc)
    scorer = scorer()
...
if __name__ == '__main__':
    ...
    nb_filter = [(200,100,100),(200,150,100),(150,100,100),(200,150,100),(200,100,100)]
    filter_list = [(2,10,20),(3,15,30),(4,9,16),(2,8,20),(3,12,15)]
