...
def build_model(lr, activation, nb_filter, filter_length1, filter_length2, filter_length3,
    ...
    model.add_node(Dense(19),name='final', input = 'connf')
    ...
    if train:
        ...
        open('exp_conn_architecture.json', 'w').write(json_string)
    return model
    ...
    class scorer(Callback):
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if acc_dev > scorer.dev_best_acc:
                ...
                model.save_weights('conn_cnn_weights.h5' ,overwrite=True)
            if epoch % 3 == 0:
                print('the best dev is conn_cnn_weights.h5:',nb_filter, filter_length1, filter_length2, filter_length3, 'epoch', scorer.dev_epoch_th, 'dev_best_acc:', scorer.dev_best_acc)
            print()
            sys.stdout.flush()
